      ...
      <div className="container is-narrow">
        <div className="columns is-centered mb-6">
          ...
          <div className="column social-icons is-one-quarter is-flex is-justify-content-space-evenly">
            ...
            <a
              className="linkedin"
              href="https://www.linkedin.com/in/mikelindesign/"
              target="_blank"
              rel="noreferrer"
              alt="Mike Lin LinkedIn"
              title="Mike Lin LinkedIn"
              aria-label="LinkedIn"
            >
              <FontAwesomeIcon
                icon={["fab", "linkedin"]}
            ...
            <a
              className="github"
              href="https://github.com/MikeUIDev"
              target="_blank"
              rel="noreferrer"
              alt="Mike Lin GitHub"
              title="Mike Lin GitHub"
              aria-label="GitHub"
            >
              <FontAwesomeIcon
                icon={["fab", "github"]}
            ...
            <a
              className="youtube"
              href="https://www.youtube.com/channel/UCmCK0FAXOLkXB3A6w3w9mIA"
              target="_blank"
              rel="noreferrer"
              alt="YouTube Music Channel Urban Lofi Studio"
              title="YouTube Music Channel Urban Lofi Studio"
              aria-label="YouTube"
            >
              <FontAwesomeIcon
            ...
            <a
              id="myEmail"
              className="email"
              href="mailto:mike&#64;mikelinstudio&#46;com"
              target="_blank"
              rel="noreferrer"
              alt="Mike Lin Email"
              title="Mike Lin Email"
              aria-label="Email"
            >
              <FontAwesomeIcon
                icon={faEnvelope}
